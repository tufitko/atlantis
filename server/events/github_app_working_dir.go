...
func (g *GithubAppWorkingDir) CloneForce(logger logging.SimpleLogging, headRepo models.Repo, p models.PullRequest, workspace string) (string, error) {
	baseRepo := &p.BaseRepo
...
func (g *GithubAppWorkingDir) CloneCheckUpstreams(logger logging.SimpleLogging, headRepo models.Repo, p models.PullRequest, workspace string) (string, error) {
	baseRepo := &p.BaseRepo
